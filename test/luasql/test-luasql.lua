...
-- if type(arg[1]) ~= "string" then
	-- print (string.format ("Usage %s <data source> [, <user> [, <password>]]", arg[0]))
	-- os.exit()
-- end

driver = "odbc"
datasource = arg[1] or CNN_DSN[1] or "luasql-test"
username   = arg[2] or CNN_DSN[2] or nil
password   = arg[3] or CNN_DSN[3] or nil
